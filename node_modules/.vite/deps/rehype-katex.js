...
import {
  ...
  svg,
  visit
} from "./chunk-IC4YXNAE.js";
import {
  convert
} from "./chunk-IYSTTPNO.js";
...
function element2(node, options) {
...
function rehypeKatex(options) {
  ...
  return (tree, file) => {
    visit(tree, "element", (element3) => {
      const classes = element3.properties && Array.isArray(element3.properties.className) ? element3.properties.className : [];
      const inline = classes.includes("math-inline");
      const displayMode = classes.includes("math-display");
      if (!inline && !displayMode) {
        return;
      }
      const value = toText(element3, { whitespace: "pre" });
      let result;
      try {
        ...
        file[fn](error.message, element3.position, origin);
      ...
      element3.children = root2.children;
    });
  };
}
export {
